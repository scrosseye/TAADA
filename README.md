...
3. The script and data to calculate Conditional probability for individual words is in the cp_code.zip file labeled cp_code.zip. The code was written by Joon Suh Choi.
